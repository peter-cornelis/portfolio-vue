...
<template>
    <div class="fixed bottom-4 right-4 z-90">
        ...
        <button @click="toggleChat" :aria-label="t(open ? 'general.close_chat' : 'general.chat')" class="grid relative items-center justify-center shadow-black/50 btn-circle w-12 h-12 rounded-full cursor-pointer">
            ...
            <form @submit.prevent="submit" class="grid gap-4">
                ...
                {{ t('chat.ask') }}
                    ...
                    <input
                        ...
                        id="question" class="contrastic w-full"
                        :class="{ 'animate-shake': shake }" :placeholder="t('chat.placeholder')">
                </label>
                <div class="relative">
                    <div @click="shaker(inputFilled)" class="absolute w-full h-full cursor-not-allowed" :class="{ 'z-20': !inputFilled  }"></div>
                    <button
                        type="submit" class="relative w-full"
