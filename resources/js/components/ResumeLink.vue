...
<template>
    <a href="/download-pdf" target="_blank" :aria-label="t('general.download_cv')" rel="noopener noreferrer"
        class="rounded-sm bg-darkPrimary/60 dark:bg-primary/70 text-primary dark:text-text text-sm font-semibold relative flex items-center gap-1 cursor-pointer" @mouseover="hover = true" @mouseleave="hover = false">
